...
const PlanEdit = () => {
  ...
  const submitEditPlan = () => {
    ...
    for (i = 0; i < rowCount; i++) {
      ...
      dict.push({
        sectionId: (document.getElementById(SECTIONID) as HTMLInputElement)
          .innerText,
        totalSeats: (document.getElementById(TOTALSEATS) as HTMLInputElement)
          .value
          ? (document.getElementById(TOTALSEATS) as HTMLInputElement).value
          : (document.getElementById(TOTALSEATS) as HTMLInputElement)
              .placeholder,
        price: (document.getElementById(PRICE) as HTMLInputElement).value
          ? (document.getElementById(PRICE) as HTMLInputElement).value
          : (document.getElementById(PRICE) as HTMLInputElement).placeholder,
      });
    }
    ...
    <div>
      ...
      <div>
        <table className="table table-hover">
          ...
          <tr>
            <td id="sectionId_1" className="hidden">
              1
            </td>
            <td>Cat 1</td>
            <td>
          ...
          <tr>
            <td id="sectionId_2" className="hidden">
              2
            </td>
            <td>Cat 2</td>
            <td>
          ...
          <tr>
            <td id="sectionId_3" className="hidden">
              3
            </td>
            <td>Cat 3</td>
            <td>
