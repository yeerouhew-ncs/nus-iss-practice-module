...
const UserHeader: React.FC<LoginProps> = ({ setAuth, setUser }) => {
  const imageBasePath =
    ...
    <>
      <div>
        ...
        >
          ...
          >
            <Link to={"/user/event/list"} className={`${styles.underLine2}`}>
              <Button variant="text" color="default">
                EVENT
              </Button>
            </Link>
            <Link to={"/user/venue/list"} className={`${styles.underLine2}`}>
              <Button variant="text" color="default">
                VENUE
              </Button>
            </Link>
