...
public class EventController {
    ...
    public ResponseEntity<?> editEvent(@RequestBody EditEventDto editEventDto) throws Exception {
        log.info("START: EDIT EVENT");
        return eventManager.editEvent(editEventDto);
    }
}
